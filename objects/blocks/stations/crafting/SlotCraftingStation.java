...
public class SlotCraftingStation extends Slot
{
    ...
    public SlotCraftingStation(EntityPlayer player, InventoryCrafting craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
