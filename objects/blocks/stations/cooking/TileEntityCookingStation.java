...
public class TileEntityCookingStation extends TileEntity implements ITickable, IInventory
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.cooking_station";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				BlockCookingStation.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = CookingStationRecipes.getInstance().getCookingResult((ItemStack)this.inventory.get(0), (ItemStack)this.inventory.get(1));	
	...
	public void smeltItem() 
	{
		if(this.canSmelt()) 
		{
			...
			ItemStack result = CookingStationRecipes.getInstance().getCookingResult(input1, input2);
			ItemStack output = (ItemStack)this.inventory.get(3);
	...
	public static int getItemBurnTime(ItemStack fuel) 
	{
		...
		else 
		{
			...
			if (item instanceof ItemDoor) return 200;
	...
	{
		return "falloutmod:cooking_station";
	}
